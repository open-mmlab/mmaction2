...
paris = {
    ...
    'kinetics': ((0, 0), (1, 0), (2, 1), (3, 2), (4, 3), (5, 1), (6, 5),
                 (7, 6), (8, 2), (9, 8), (10, 9), (11, 5), (12, 11), (13, 12),
...
for dataset in datasets:  # benchmark
    for set in sets:  # part
        ...
        path = os.path.join(
            '/mnt/lustre/liguankai/data/ntu/nturgb+d_skeletons_60_3d_nmtvc',
            dataset)
        ...
        for i, item in enumerate(data):
            ...
            for v1, v2 in paris[dataset]:
                ...
                v2 -= 1
                bone[:, :,
                     v1, :] = keypoint[:, :, v1, :] - keypoint[:, :, v2, :]
            item['keypoint'] = bone
            results.append(item)
            prog_bar.update()

        out_path = os.path.join(
            '/mnt/lustre/liguankai/data/ntu/nturgb+d_skeletons_60_3d_bone',
            dataset)

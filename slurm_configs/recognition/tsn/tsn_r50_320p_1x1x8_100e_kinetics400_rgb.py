...
ann_file_train = 'data/kinetics400/kinetics_train_list_320p.txt'
ann_file_val = 'data/kinetics400/kinetics_val_list_320p.txt'
ann_file_test = 'data/kinetics400/kinetics_val_list_320p.txt'
img_norm_cfg = dict(

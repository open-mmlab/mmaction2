...
class TransformerAdapter(BaseModule):
    ...
    def __init__(self,
        ...
        self.positional_embedding = nn.Parameter(torch.empty(num_segs, transformer_width))
...
class SimpleMeanAdapter(BaseModule):
    """Average features adpater.

    Args:
        dim (int): The dimention to perform averaging. Defaults to 1.
    """

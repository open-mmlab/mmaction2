...
from transformers.models.beit.modeling_beit import BeitRelativePositionBias as BeitRelativePositionBias2D
...
from transformers.models.beit.modeling_beit import BeitRelativePositionBias, BeitAttention, BeitDropPath

from mmaction.registry import MODELS
from .temporal_model import (X_CLIP, STAdapter, TemporalAttention, TemporalS4, WindowTemporalAttention)
...
class BeitModel3D(BeitModel):
    ...
    # move layernorm into BeitModel3D will introduce checkpoint incompatiable with the original repo
    #     if add_ln:
    ...
    #     output_dict = super().forward(inputs)
    #     vision_embeds = self.layernorm(output_dict.last_hidden_state)

...
class ImigueDataset(BaseDataset):
    ...
    def __init__(self, ann_file, pipeline, subset, data_prefix=None, test_mode=False):
        self.subset = subset
    ...
    def load_annotations(self):
        ...
        if 'database' in anno_database.keys():
        ...
        for video_name in anno_database:
            ...
            if self.subset != video_info['subset']:
                continue

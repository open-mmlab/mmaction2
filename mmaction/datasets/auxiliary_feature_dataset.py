...
class AuxiliaryFeatureDataset(BaseDataset):
    """Feature dataset for video recognition.
    ...
    Args:
        ...
        feature_name (str): The name of the auxiliary feature. Default: 'text'.
        suffix (str): The suffix of the audio file. Default: '.json'.
        ...
        with open(self.ann_file, 'r') as fin:
            for line in fin:
                ...
                if not filename.endswith(self.suffix):
                    filename, _ = osp.splitext(filename)
                    filename = osp.join(filename, self.suffix)
                video_info[f'{self.feature_name}_feature_path'] = filename
                idx += 1

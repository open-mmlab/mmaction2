...
ann_file_train = 'data/k400/kinetics_train_list_hd320.txt'
ann_file_val = 'data/k400/kinetics_val_list_hd320.txt'
ann_file_test = 'data/k400/kinetics_val_list_hd320.txt'
img_norm_cfg = dict(

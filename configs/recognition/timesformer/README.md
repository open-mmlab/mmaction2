...
4. The model `timesformer_divST_8x32x1` from [original repo](https://github.com/facebookresearch/TimeSformer) get 77.48 (93.19) top-1 (top-5) accuracy in our kinetics dataset.

...
ann_file_train = 'data/action_seg/gtea/splits/train.split4.bundle'
ann_file_val = 'data/action_seg/gtea/splits/test.split4.bundle'
ann_file_test = 'data/action_seg/gtea/splits/test.split4.bundle'
...
work_dir = './work_dirs/asformer_gtea4/'
test_evaluator = dict(
    type='SegmentMetric',
    metric_type='ALL',

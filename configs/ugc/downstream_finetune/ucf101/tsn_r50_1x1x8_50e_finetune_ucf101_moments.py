...
# optimizer
optimizer = dict(
    type='SGD', lr=0.003125, momentum=0.9,
    weight_decay=0.0005)  # this lr is used for 1 gpus
...
log_level = 'INFO'
work_dir = './work_dirs/tsn_r50_1x1x8_50e_finetune_ucf101_moments/'
load_from = ('ckpts/' + 'tsn_r50_1x1x6_100e_mit_rgb_20200618-d512ab1b.pth')
resume_from = None
workflow = [('train', 1)]

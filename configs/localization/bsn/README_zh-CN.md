...
对于数据集准备的细节，用户可参考 [数据集准备文档](/docs/en/zh_cn/data_preparation.md) 中的 ActivityNet 特征部分。
...
更多训练细节，可参考 [基础教程](/docs/en/zh_cn/getting_started.md#训练配置) 中的 **训练配置** 部分。
...
更多测试细节，可参考 [基础教程](/docs/en/zh_cn/getting_started.md#测试某个数据集) 中的 **测试某个数据集** 部分。

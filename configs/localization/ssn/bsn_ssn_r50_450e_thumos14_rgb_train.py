...
# dataset settings
dataset_type = 'BSNSSNDataset'
data_root = '/media/micro-gesture/data/mg_preprocessing'
data_root_val = '/media/micro-gesture/data/mg_preprocessing'
ann_file_train = 'data/iMiGUE/proposals/imigue_formatted_proposal_bsn_train.txt'
ann_file_val = 'data/iMiGUE/proposals/imigue_formatted_proposal_bsn_train.txt'
ann_file_test = 'data/iMiGUE/proposals/imigue_formatted_proposal_bsn_test.txt'

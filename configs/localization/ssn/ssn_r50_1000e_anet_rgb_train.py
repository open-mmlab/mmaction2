...
train_cfg = dict(
    ssn=dict(
        assigner=dict(
            ...
            incomplete_overlap_threshold=0.6),
        sampler=dict(
            num_per_video=8,
            positive_ratio=1,
            background_ratio=1,
...
ann_file_train = 'anet_val_formatted_proposal.txt'
ann_file_val = 'anet_val_formatted_proposal.txt'
ann_file_test = 'anet_val_formatted_proposal.txt'
...
# learning policy
lr_config = dict(policy='step', step=[200, 400, 600, 800])
...
log_level = 'INFO'
work_dir = './work_dirs/ssn_r50_1x5_1000e_anet_rgb'
load_from = None
resume_from = None
workflow = [('train', 1)]

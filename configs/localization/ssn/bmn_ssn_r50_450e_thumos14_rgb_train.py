...
# dataset settings
dataset_type = 'BMNSSNDataset'
data_root = '/media/micro-gesture/data/mg_preprocessing'
data_root_val = '/media/micro-gesture/data/mg_preprocessing'
ann_file_train = 'data/iMiGUE/proposals/imigue_formatted_proposal_bmn_train+1.txt'
ann_file_val = 'data/iMiGUE/proposals/imigue_formatted_proposal_bmn_train+1.txt'
ann_file_test = 'data/iMiGUE/proposals/imigue_formatted_proposal_bmn_test+1.txt'

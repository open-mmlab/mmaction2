...
def parse_args():
    ...
    parser.add_argument(
        '--config', help=('spatio temporal detection config '
                          'file path'))
    parser.add_argument(
        '--checkpoint',
        help=('spatio temporal detection '
              'checkpoint file/url'))
    parser.add_argument(
        '--det-config',
        help=('human detection config file '
              'path (from mmdet)'))
    parser.add_argument(
        '--det-checkpoint', help=('human detection checkpoint '
                                  'file/url'))
    parser.add_argument(
        '--video', help=('video file/url or rawframes '
                         'directory'))
    parser.add_argument('--label', help='label file')
    parser.add_argument(
        '--device', type=str, default='cuda:0', help='CPU/CUDA device option')
    parser.add_argument(
        '--fps', default=30, type=int, help='specify fps value of the video')

...
from mmaction.evaluation import build_tubes, frameAP, videoAP, videoAP_all
from mmaction.registry import METRICS


@METRICS.register_module()
class MultiSportsMetric(BaseMetric):
    """MAP Metric for MultiSports STAD task."""
    ...
    def __init__(self,
                 ...
                 metric_options: Optional[dict] = dict(
                     F_mAP=dict(thr=(0.5)),
                     V_mAP=dict(thr=(0.2, 0.5), all=True)),
    ...
    def compute_metrics(self, results: list) -> dict:
        ...
        video_tubes = build_tubes(self.annos, frm_detections)
